...
document.addEventListener("DOMContentLoaded", function () {
    ...
    let user_id_param = params['key'];

    db.collection("users").where('id', '==', user_id_param).get().then((querySnapshot) => {
...
// Busca y presenta mis publicaciones
...
// Controla los me gusta de mis publicaciones
